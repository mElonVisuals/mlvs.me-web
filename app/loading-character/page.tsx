  ...
  const destinations = [
    {
      ...
      description: "Advanced system monitoring and analytics platform",
      icon: Terminal,
      color: "from-blue-500 to-cyan-500",
      route: "/dashboard",
      features: ["Real-time metrics", "System logs", "Performance graphs"],
    },
    {
      id: "fivem",
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-md border-b border-gray-800/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Button onClick={toggleAnimation} variant="ghost" size="sm" className="text-gray-400 hover:text-gray-100">
              {isAnimating ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
            </Button>
            <Button onClick={resetAnimation} variant="ghost" size="sm" className="text-gray-400 hover:text-gray-100">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105"
                >
                  Return to Homepage
                </Button>
              </div>
